...
version: "0.5.4"
date: "Wed, 8 Jan 2025 16:25:14 +0100"
hash: "579bd12e792667c968ab64d07f56c6b7da72b4e2"
---
...
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| (lr)1-4 221 |   | 0 | ${\registers}'_D = \mathcal{X}_4(x)\ \where x \in \N_{2^{32}}, \forall i \in \N_{32} : \mathcal{B}_{4}(x)_{(i + {\registers}_A) \bmod 32} = \mathcal{B}_{4}({\registers}_A)_i$ |
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| (lr)1-4 222 |   | 0 | $\forall i \in \N_{64} : \mathcal{B}_{8}({\registers}'_D)_i = \mathcal{B}_{8}({\registers}_A)_{(i + {\registers}_B) \bmod 64}$                                                 |
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| (lr)1-4 223 |   | 0 | ${\registers}'_D = \mathcal{X}_4(x)\ \where x \in \N_{2^{32}}, \forall i \in \N_{32} : \mathcal{B}_{4}(x)_i = \mathcal{B}_{4}({\registers}_A)_{(i + {\registers}_A) \bmod 32}$ |
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
