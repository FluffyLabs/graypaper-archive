...
version: "0.6.1"
date: "Sun, 2 Feb 2025 12:11:59 +0100"
hash: "4bb8fd258ee2d49767f6725993fb5a4045ee19a3"
---
...
Where: $$\begin{aligned}
  ...
  \mathbf{o} = \,&\Psi_I(p, c) \ ,\quad \overline{\mathbf{i}} = [S(w, \mathbf{l}) \mid w \orderedin p_\wpNworkitems] \\
  ...
  I(p, j) \equiv \,&\begin{cases}
    ...
    \multicolumn{2}{l}{\where (r, \mathbf{e}) = \Psi_R(
      j, p, \mathbf{o}, \overline{\mathbf{i}}, \ell
    )
    }\\
    \multicolumn{2}{l}{\also \ell = \sum_{k < j}p_\wpNworkitems[k]_\wiNexportsegments}
  \end{cases}\end{aligned}$$
...
The above relies on the function $S$ which defines the import segment data for some work-item argument $w$. We also define $X$ and $J$, which compiles the extrinsic data and the justifications of segment data: $$\begin{aligned}
...
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| (lr)1-4 227 |   | 0 | ${\registers}'_D = \max ( \mathcal{Z}_{8}({\registers}_A), \mathcal{Z}_{8}({\registers}_B) )$                                                                                  |
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| (lr)1-4 228 |   | 0 | ${\registers}'_D = \max ( {\registers}_A, {\registers}_B )$                                                                                                                    |
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| (lr)1-4 229 |   | 0 | ${\registers}'_D = \min ( \mathcal{Z}_{8}({\registers}_A), \mathcal{Z}_{8}({\registers}_B) )$                                                                                  |
+-------------+---+---+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  ...
  **Gas usage**              
  ...
  $g = 10$                   $\begin{aligned}
                                 ...
                                 (\varepsilon', \registers'_7) &\equiv \begin{cases}
                                   ...
                                   (\blacktriangleright, \mathtt{NONE}) &\otherwhen \mathbf{v} = \none \\
                                   (\blacktriangleright, |\mathbf{v}|) &\otherwise \\
                                 \end{cases}
                               \end{aligned}$
  (lr)1-1(lr)2-2             
  `export` = 19              
